...
#
# project2018.tcl: Tcl script for re-creating project 'mix_compress'
#
# Generated by Vivado on Sun Jan 18 17:57:44 +0800 2026
...
#
# 1. This project restoration tcl script (project2018.tcl) that was generated.
#
...
set _xil_proj_name_ "mix_compress"
...
set script_file "project2018.tcl"
...
set orig_proj_dir "[file normalize "$origin_dir/../05.prj"]"
...
set files [list \
 [file normalize "${origin_dir}/../02.rtl/lz4/abs_addr_gen_v3.v"] \
 [file normalize "${origin_dir}/../02.rtl/huffman/bit_len_gen.v"] \
 [file normalize "${origin_dir}/../02.rtl/huffman/bl_table.v"] \
 [file normalize "${origin_dir}/../02.rtl/lz4/byte_addressing_v4.v"] \
 [file normalize "${origin_dir}/../02.rtl/mux/cascade_logic.v"] \
 [file normalize "${origin_dir}/../02.rtl/huffman/code_lookup_v2.v"] \
 [file normalize "${origin_dir}/../02.rtl/huffman/compare_unit.v"] \
 [file normalize "${origin_dir}/../02.rtl/lz4/control_fsm_v3.v"] \
 [file normalize "${origin_dir}/../02.rtl/huffman/dff_array.v"] \
 [file normalize "${origin_dir}/../02.rtl/lz4/encode_glue.v"] \
 [file normalize "${origin_dir}/../02.rtl/huffman/encode_v3.v"] \
 [file normalize "${origin_dir}/../02.rtl/huffman/fifo_16x20bit.v"] \
 [file normalize "${origin_dir}/../02.rtl/lz4/fifo_512x47bit.v"] \
 [file normalize "${origin_dir}/../02.rtl/huffman/freq_ram_256x18bit.v"] \
 [file normalize "${origin_dir}/../02.rtl/lz4/hash_4port_32Kx65bit.v"] \
 [file normalize "${origin_dir}/../02.rtl/lz4/hash_match.v"] \
 [file normalize "${origin_dir}/../02.rtl/lz4/hash_table_v3.v"] \
 [file normalize "${origin_dir}/../02.rtl/huffman/heap_sorter_v3.v"] \
 [file normalize "${origin_dir}/../02.rtl/huffman/huffman_encoder_v5.v"] \
 [file normalize "${origin_dir}/../02.rtl/huffman/little_root_heap.v"] \
 [file normalize "${origin_dir}/../02.rtl/lz4/lz4_buffer_v2.v"] \
 [file normalize "${origin_dir}/../02.rtl/lz4/lz4_encoder_v3.v"] \
 [file normalize "${origin_dir}/../02.rtl/lz4/lz4_top_v3.v"] \
 [file normalize "${origin_dir}/../02.rtl/huffman/node_unit.v"] \
 [file normalize "${origin_dir}/../02.rtl/huffman/reg_array_16x9bit.v"] \
 [file normalize "${origin_dir}/../02.rtl/huffman/select_network.v"] \
 [file normalize "${origin_dir}/../02.rtl/lz4/shifter_96bit_v3.v"] \
 [file normalize "${origin_dir}/../02.rtl/lz4/shifter_match.v"] \
 [file normalize "${origin_dir}/../02.rtl/lz4/shifter_prefetch.v"] \
 [file normalize "${origin_dir}/../02.rtl/huffman/tree_build_v3.v"] \
 [file normalize "${origin_dir}/../02.rtl/lz4/unmatch_fifo_v3.v"] \
 [file normalize "${origin_dir}/../02.rtl/huffman/vlc_glue_v4.v"] \
 [file normalize "${origin_dir}/../02.rtl/huffman/vlc_table_v3.v"] \
 [file normalize "${origin_dir}/../02.rtl/lz4/xxh32_calc_v2.v"] \
 [file normalize "${origin_dir}/../02.rtl/mux/mix_compression_top.v"] \
 [file normalize "${origin_dir}/../02.rtl/include.v"] \
]
...
set files [list \
 [file normalize "${origin_dir}/../03.sim/mix_compression_top_tb.sv"] \
 [file normalize "${origin_dir}/../03.sim/byte_addressing_tb_v2.v"] \
 [file normalize "${origin_dir}/../03.sim/huffman_encode_tb.v"] \
 [file normalize "${origin_dir}/../03.sim/lz4_buffer_tb_v2.v"] \
 [file normalize "${origin_dir}/../03.sim/lz4_encoder_tb.v"] \
 [file normalize "${origin_dir}/../03.sim/lz4_top_tb_v2.v"] \
 [file normalize "${origin_dir}/../03.sim/xxh32_cal_tb.v"] \
]
add_files -norecurse -fileset $obj $files

# Import local files from the original project
set files [list \
 [file normalize "${origin_dir}/../05.prj/mix_compression_top_tb_behav.wcfg" ]\
]
set imported_files [import_files -fileset sim_1 $files]

# Set 'sim_1' fileset file properties for remote files
set file "$origin_dir/../03.sim/mix_compression_top_tb.sv"
...
set obj [get_filesets sim_1]
set_property -name "top" -value "mix_compression_top_tb" -objects $obj
